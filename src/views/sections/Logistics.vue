...
<div>
  <hero
    title="Logistics"
    subtitle="How to get there & what is around"
    position="up"
    theme="white"
  ...
  <pre class="padding-ends-4" style="background-color: #EEE; margin: 0;">
    ...
    Lodging
      Pinecrest Chalet (The Venue)
        https://alumni.berkeley.edu/travel/pinecrest-chalet/planning-your-trip/accommodations
      McCaffrey House B&B https://mccaffreyhouse.com/yosemite-area-bed-and-breakfast-lodging/
      Pinecrest Resort http://pinecrestlakeresort.com/pinecrest-lodging.html
      Strawberry Inn http://www.strawberryinn.com/

    Local Activities
      Hiking
        https://www.alltrails.com/trail/us/california/cleos-bath-trail
        https://www.alltrails.com/trail/us/california/pinecrest-peak-trail
        https://www.alltrails.com/trail/us/california/pinecrest-lake-loop
      Paddle Boating http://pinecrestlakeresort.com/pinecrest-marina.html
      Kayaking http://pinecrestlakeresort.com/pinecrest-marina.html
      Horse Back Riding: http://www.aspenmeadowpackstation.com/
      Climbing https://www.mountainproject.com/area/107299550/sonora-pass-highway-108
